...
public class BasePage {
	...
	protected String getSelectItemDefaultDropdownList(WebDriver driver, String xpathLocator, String textItem) {
		Select select = new Select(getWebElement(driver, xpathLocator));
	...
	protected void selectItemInCustomDropdown(WebDriver driver, String parentXpath, String childXpath, String expectItem) {
